...
public class MainActivity3 extends AppCompatActivity
    ...
    private final TextureView.SurfaceTextureListener mSurfaceTextureListener
        ...
        public void onSurfaceTextureUpdated(SurfaceTexture texture) {
            ...
            drawRectangle(frame);
            // Log.e(TAG, "onSurfaceTextureUpdated: "+frame.getWidth()+"   "+ frame.getHeight());
...
//
            ...
            Intent intent = new Intent(MainActivity3.this, CropImageActivity.class);
...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
         String   value = extras.getString("start");
...
//                    .show(getChildFragmentManager(), FRAGMENT_DIALOG);
    ...
    private class ImageSaver implements Runnable {
        ...
        public void run() {
            ...
            File file = new File(MainActivity3.this.getApplicationContext().getCacheDir(), "temp.jpg");
            ...
            Intent intent = new Intent(com.example.mylibrary.MainActivity3.this, com.example.mylibrary.CropImageActivity.class);
